...
export async function GET(request: Request) {
  try {
    ...
    const { data, error } = await supabase
      ...
      .select("id, title, description, xp, status, category, action_label, action_url, requires_proof, requires_message, is_quiz, quiz_answer, quiz_options, correct_option_index, passcode, publish_at, expires_at, depends_on_quest_id, discord_guild_id, telegram_chat_id, sort_order, created_by, updated_by, created_at, updated_at")
